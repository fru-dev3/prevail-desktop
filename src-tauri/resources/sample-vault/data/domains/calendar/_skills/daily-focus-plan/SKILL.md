...
runner: llm
trigger: on-demand
description: Shape the day around one real priority: the must-do, the time it lives in, and what gets cut.
source: seed
---
...
Output: the one priority with its protected block, the sequenced day, and the explicit cut list.
