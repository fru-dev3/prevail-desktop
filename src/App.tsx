      ...
      <div className="flex min-h-0 flex-1">
        ...
        <main className="flex min-w-0 flex-1 flex-col">
          <div data-tour="nav" className="relative flex shrink-0 items-center gap-1 border-b border-border-subtle bg-background pl-1.5 pr-4">
            ...
            {import.meta.env.DEV && (
              <span className="pointer-events-none absolute bottom-0.5 right-1.5 z-10 rounded bg-err px-1 py-0 font-mono text-[8px] font-bold uppercase tracking-wide text-background opacity-70">DEV</span>
            )}
                ...
                <>
                  ...
                  >
                    ...
                    {dueAlert.open > 0 && (
                      ...
                      // bg-ai pill. (The old conditional bg-err/bg-warn classes
